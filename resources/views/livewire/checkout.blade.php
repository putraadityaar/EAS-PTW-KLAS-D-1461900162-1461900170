        ...
        <div class="col">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    No. Rekening 012345-678-910 atas nama <strong>Mohammad Alif B</strong>
                </div>
                <div class="media">
                <img class="mr-3" src="{{ url('assets/bca.jpg') }}" alt="Bank BRI" width="60">
                <div class="media-body">
                    <h5 class="mt-0">BANK BCA</h5>
                    No. Rekening 09876-654-321 atas nama <strong>Putra Aditya</strong>
                </div>
            </div>
        </div>
        <div class="col">
